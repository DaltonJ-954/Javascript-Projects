...
import type GenreCreate from "../models/GenreCreate.model";
...
const { id } = useParams();
const [model, setModel] = useState<GenreCreate | undefined>(undefined);
...
const onSubmit: SubmitHandler<GenreCreate> = async (data) => {
        try {
