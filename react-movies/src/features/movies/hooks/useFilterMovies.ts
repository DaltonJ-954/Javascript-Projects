...
export default function useFilterMovies(initialValues: FilterMoviesDTO, setValue: UseFormSetValue<FilterMoviesDTO>) {
    const [genres, setGenres] = useState<Genre[]>([]);
        ...
        async function loadRecords(values: FilterMoviesDTO) {
            ...
            setTotalAmountOfRecords(parseInt(response.headers['all-records'], 10));
        }
    ...
    return { loadRecords, genres, page, recordsPerPage, totalAmountOfRecords, 
        setPage, setRecordsPerPage, movies }
}