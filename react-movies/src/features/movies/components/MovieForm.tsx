...
export default function MovieForm(props: MovieFormProps) {
    ...
    const {
        ...
        mode: 'onChange',
        defaultValues: props.model ?? { title: '', releaseDate: '' , trailer: '', genresIds: [], theatersIds: [], actors: [] }
    })
        ...
        <>
            ...
            <form onSubmit={ handleSubmit(onSubmit) }>
                ...
                <div className="form-group">
                    ...
                    <input id="releaseDate" autoComplete="off" type="date" className="form-control" { ...register('releaseDate') } />
