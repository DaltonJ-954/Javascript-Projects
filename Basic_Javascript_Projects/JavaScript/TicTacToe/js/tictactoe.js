...
let activePlayer = 'X';
//This array stores an array of moves. We use this to determone win conditions.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //squareNumbaer and activePlayer are concatenated together and added to array.
    ...
    function checkWinConditions() {
        ...
        function arrayIncludes(squareA, squareB, squareC) {
            //These 3 variables will be used to checkk for 3 in a row.
    ...
    //placement sound('.med ia/place.mp3')
    function audio(audioURL) {
        //We create a new audio object and we pass the path as a patemeter.
        let audio = new Audio(audioURL);
        //Play method plays our audio sound.
        audio.play();
    }

    //This function utilizes HTML canvas to draw winn lines.
...
//This function s the game in the event of a tie or win.
function resetGame() {
    //This for loop iterates through each HTML square element.
    for (let i = 0; i < 9; i++) {
        //This variable hets the HTML element.
