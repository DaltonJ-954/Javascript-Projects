...
const Calculator = {
    ...
    First_Operand: null,
    //This checks wether or not the seondond operand has been inputted by the user.
...
function Handle_Operator(Next_Operator) {
    ...
    //When and operator key is pressed we convert the current number
...
keys.addEventListener('click', (event) => {
    ...
    //Ensures the AC clears all the inputs from the Calculator screen.
